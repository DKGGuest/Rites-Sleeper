                    ...
                    <div className="fade-in">
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px' }}>
                            <div style={{ borderLeft: '4px solid #8b5cf6', padding: '24px', background: '#fff', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)', border: '1px solid #e2e8f0' }}>
                                <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '12px', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Cement (OPC-53)</div>
                                <div style={{ fontSize: '2.25rem', fontWeight: '700', color: '#1e293b', marginBottom: '8px' }}>120.5 MT</div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                    <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#10b981' }}></span>
                                    <span style={{ fontSize: '0.85rem', color: '#10b981', fontWeight: '500' }}>Enough for 3 days</span>
                                </div>
                            </div>
                            <div style={{ borderLeft: '4px solid #3b82f6', padding: '24px', background: '#fff', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)', border: '1px solid #e2e8f0' }}>
                                <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '12px', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.5px' }}>20mm Aggregate</div>
                                <div style={{ fontSize: '2.25rem', fontWeight: '700', color: '#1e293b', marginBottom: '8px' }}>450.0 MT</div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                    <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#10b981' }}></span>
                                    <span style={{ fontSize: '0.85rem', color: '#10b981', fontWeight: '500' }}>Full Capacity</span>
                                </div>
                            </div>
                            <div style={{ borderLeft: '4px solid #f59e0b', padding: '24px', background: '#fff', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)', border: '1px solid #e2e8f0' }}>
                                <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '12px', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.5px' }}>10mm Aggregate</div>
                                <div style={{ fontSize: '2.25rem', fontWeight: '700', color: '#1e293b', marginBottom: '8px' }}>320.3 MT</div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                    <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#f59e0b' }}></span>
                                    <span style={{ fontSize: '0.85rem', color: '#f59e0b', fontWeight: '500' }}>Low Stock Concern</span>
                                </div>
                            </div>
                            <div style={{ borderLeft: '4px solid #10b981', padding: '24px', background: '#fff', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)', border: '1px solid #e2e8f0' }}>
                                <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '12px', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Admixture</div>
                                <div style={{ fontSize: '2.25rem', fontWeight: '700', color: '#1e293b', marginBottom: '8px' }}>2,400 L</div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                    <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#10b981' }}></span>
                                    <span style={{ fontSize: '0.85rem', color: '#10b981', fontWeight: '500' }}>Stock Healthy</span>
                                </div>
                            </div>
                        </div>
                    </div>
